...
const NavBar = () => {
  ...
  return (
    <>
    <Box className="text-white bg-red-500 py-2 mb-0.5 font-serif font-semibold shadow-2xl rounded-bl-3xl rounded-br-3xl">
      Website is currently under construction, Thank you for your patience!
    </Box>
      <Box
        className="flex justify-between bg-blue.200 items-center h-13 border px-5 sm:px-10 bg-blue-50 rounded sticky top-0 z-10 mb-5"
        minW="350px"
      >
